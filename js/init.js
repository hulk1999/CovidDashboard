window.onload = function (e) {
  ...
  startTxt.innerHTML = timestamp2DateStr(
    casesData.DailyCases[PERIODS[id][0]][0]
  )
  endTxt.innerHTML = timestamp2DateStr(
    casesData.DailyCases[PERIODS[id][1] - 1][0]
  )
  ...
  const foreign_optionsContainer = document.querySelector(
    '.foreign-options-container'
  )
