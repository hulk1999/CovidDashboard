...
Highcharts.mapChart('map-chart-container', {
  ...
  colorAxis: {
    ...
    labels: {
      style: {color: 'white'},
      formatter: function(){return this.value + (this.isLast ? '+' : '')}
    },
  },
  legend: {
    // symbolWidth: 300,
  ...
  tooltip: {
    ...
    formatter: function() {
      ...
      text += '<div class="tooltip-info-column">Ca nhiễm:&nbsp;<br>Tử vong:&nbsp;</div>';
      text += `<div class="tooltip-info-column">${addSeparator(this.point.cases, ' ')}<br>`;
