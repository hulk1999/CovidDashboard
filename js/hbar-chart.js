...
const data = [
  casesData.CurrentlyInfected[len - 1][1],
...
const data_0_format =
  data_0_format_3 + " " + data_0_format_2 + " " + data_0_format_1;
...
const data_1_format =
  data_1_format_3 + " " + data_1_format_2 + " " + data_1_format_1;
...
const data_2_format =
  data_2_format_3 + " " + data_2_format_2 + " " + data_2_format_1;

document.getElementById("hbar-current-cases-value").innerHTML =
  data_0_format + " ca";
document.getElementById("hbar-live-cases-value").innerHTML =
  data_1_format + " ca";
document.getElementById("hbar-dead-cases-value").innerHTML =
  data_2_format + " ca";
